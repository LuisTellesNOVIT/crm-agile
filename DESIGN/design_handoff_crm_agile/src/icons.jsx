// Icon set — small, consistent line icons (16px).
const Icon = ({ name, size = 16, className = "", style = {} }) => {
  ...
  switch (name) {
    ...
    case "kanban": return <svg {...props}><rect x="3" y="3" width="6" height="18" rx="1"/><rect x="11" y="3" width="6" height="11" rx="1"/><rect x="19" y="3" width="2" height="7" rx="1"/></svg>;
    case "gantt": return <svg {...props}><line x1="3" y1="6" x2="11" y2="6"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="13" y1="18" x2="21" y2="18"/></svg>;
    ...
    case "template": return <svg {...props}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>;
    ...
    case "note": return <svg {...props}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>;
    case "sparkles": return <svg {...props}><path d="M12 2 13.5 8 19 9.5 13.5 11 12 17 10.5 11 5 9.5 10.5 8 12 2z"/><path d="M19 17l.8 2.4L22 20l-2.2.6L19 23l-.8-2.4L16 20l2.2-.6L19 17z"/></svg>;
    ...
    case "logo": return <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={style}><path d="M3 4h6v3H3zM3 9h13v3H3zM3 14h9v3H3zM3 19h17v3H3z"/></svg>;
    default: return null;
  }
};
