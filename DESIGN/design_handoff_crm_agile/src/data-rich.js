// Inbox, conversations, templates, sequences, custom-objects data + helpers.
(function() {
  const D = window.CRM_DATA;

  // --- Inbox items (channel, from, subject, preview, time, unread, type)
  const inbox = {
    novit: [
  ...
  // --- Conversation threads (for selected inbox item)
  const conversations = {
    "novit:i1": [
  ...
  // Featured customer for 360 view
  const featured = {
    novit: {
      id: "ML-001",
      name: "Mercado Libre",
      ...
      owner: "MP",
      contacts: [
        { name: "Lucía Mendoza",  role: "VP Data Platform",  email: "l.mendoza@ml.com" },
        { name: "Diego Quiroga",   role: "CTO",                email: "d.quiroga@ml.com" },
        { name: "Paula Reissig",   role: "Procurement Lead",   email: "p.reissig@ml.com" }
      ],
      timeline: [
        { day: "Hoy · 18 May 2026", events: [
          { type: "wa",   text: "Lucía Mendoza confirmó reunión del jueves 10am.", who: "Lucía Mendoza", at: "10:42" },
          { type: "ai",   text: "AI Score subió de 76% → 82% por engagement reciente y tamaño de cuenta.", who: "AI", at: "09:00" }
        ]},
        { day: "Ayer · 17 May 2026", events: [
          { type: "email", text: "Propuesta v3 enviada — Data Lake + Snowflake, 540K USD, 18 meses.", who: "María Paz", at: "16:20" },
          { type: "note",  text: "Nota IA del meeting: dolor principal es lentitud en queries analíticas. Snowflake es la opción favorita.", who: "AI · Meeting recap", at: "15:00" }
        ]},
        { day: "16 May 2026", events: [
          { type: "call", text: "Llamada técnica · 47 min · revisión de arquitectura. Recording disponible.", who: "Diego Quiroga", at: "14:00" },
          { type: "wa",   text: "Paula pidió referencias de implementaciones similares en retail.", who: "Paula Reissig", at: "10:15" }
        ]},
        { day: "12 May 2026", events: [
          { type: "task", text: "Tarea creada: enviar caso Falabella + Bagley antes de la próxima reunión.", who: "María Paz", at: "11:30" }
        ]},
        { day: "8 May 2026", events: [
          { type: "deal", text: "Trato avanzó: Proposal → Negotiation. Valor actualizado 540K USD.", who: "María Paz", at: "17:00" }
        ]}
      ]
    },
    sharky: {
      ...
      owner: "AV",
      contacts: [
        { name: "Sofía Marín",      role: "Head of Growth",     email: "sofi@rappi.com" },
        { name: "Manuel Lascano",   role: "Marketing Director", email: "m.lascano@rappi.com" }
      ],
      timeline: [
        { day: "Hoy · 18 May 2026", events: [
          { type: "wa", text: "Sofía Marín pidió fechas de kickoff.", who: "Sofía Marín", at: "14:32" },
          { type: "ai", text: "Engagement alto últimas 72hs. Recomendación: cerrar esta semana.", who: "AI", at: "12:00" }
        ]},
        { day: "Ayer · 17 May 2026", events: [
          { type: "email", text: "SOW v2 enviado — Tier 2, 48K USD, 6 meses.", who: "Ariana", at: "11:00" },
          { type: "note",  text: "Nota IA: ICP fit alto (98%). Vertical: delivery LATAM.", who: "AI", at: "09:30" }
        ]},
        { day: "15 May 2026", events: [
          { type: "call", text: "Demo personalizada · 28 min. Sofía mostró interés en módulo de SDR.", who: "Sofía Marín", at: "15:00" }
        ]},
        { day: "10 May 2026", events: [
          { type: "deal", text: "Trato avanzó: Qualified → Proposal.", who: "Ariana", at: "16:45" }
        ]}
      ]
    }
  };

  // Templates (shared across workspaces)
  const templates = [
    {
      id: "t1", channel: "wa", name: "Welcome new lead",
      desc: "Primer mensaje al recibir un lead inbound",
      ...
      uses: 1248, replyRate: 67
    },
    {
      id: "t2", channel: "wa", name: "Follow-up sin respuesta",
      desc: "2do toque cuando no hay respuesta en 48hs",
      body: "Hola {{first_name}}, sé que estás ocupado/a. ¿Te queda en el radar lo de {{deal_name}}? Si querés, te mando un loom de 3min con los próximos pasos.",
      uses: 892, replyRate: 41
    },
    {
      id: "t3", channel: "email", name: "Propuesta enviada — recap",
      desc: "Email recap luego de enviar propuesta",
      ...
      uses: 412, replyRate: 78
    },
    {
      id: "t4", channel: "wa", name: "Recordatorio reunión",
      desc: "24h antes de meeting agendado",
      body: "Hola {{first_name}}! Te recuerdo nuestra reunión mañana a las {{meeting_time}}. Link: {{meeting_link}}\n\nNos vemos! 🚀",
      uses: 2104, replyRate: 22
    },
    {
      id: "t5", channel: "email", name: "Contrato ganado — bienvenida",
      desc: "Welcome al ganar el deal",
      body: "{{first_name}}, qué alegría tenerte como cliente de {{workspace_name}} 🎉\n\nEstos son los próximos pasos:\n\n1. Kickoff el {{kickoff_date}}\n2. Acceso al portal: {{portal_url}}\n3. Tu Customer Success Manager: {{csm_name}}",
      uses: 156, replyRate: 92
    },
    {
      id: "t6", channel: "wa", name: "Nurture — caso de éxito",
      desc: "Compartir caso relevante para destrabar",
      body: "Hola {{first_name}}, te comparto cómo {{similar_company}} resolvió un problema parecido al de {{company}}. Caso completo: {{case_link}}",
      uses: 645, replyRate: 38
    }
  ];
  ...
  const sequences = [
    {
      id: "s1", name: "Lead inbound — onboarding 7 días",
      active: true,
  ...
  // Custom Objects (Attio-style)
  const customObjects = [
    {
      id: "co1", name: "Leads",      icon: "L",  color: "#0ea5e9", count: 3842,
      attrs: [
    ...
    {
      id: "co2", name: "Companies", icon: "C", color: "#8b5cf6", count: 1284,
      attrs: [
    ...
    {
      id: "co3", name: "Deals", icon: "D", color: "#16a34a", count: 642,
      attrs: [
    ...
    {
      id: "co4", name: "Contracts", icon: "K", color: "#f59e0b", count: 218,
      attrs: [
  ...
  window.CRM_RICH = { inbox, conversations, featured, templates, sequences, customObjects };
})();
